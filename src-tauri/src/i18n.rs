...
pub(crate) struct NativeStrings {
    ...
    pub(crate) search_clipboard: &'static str,
    pub(crate) open_history: &'static str,
    pub(crate) open_settings: &'static str,
    pub(crate) pinned_items: &'static str,
    pub(crate) clear_history: &'static str,
    pub(crate) quit_clipecho: &'static str,
    ...
    pub(crate) about_clipecho: &'static str,
    pub(crate) services: &'static str,
    pub(crate) hide_clipecho: &'static str,
...
const ENGLISH_STRINGS: NativeStrings = NativeStrings {
    ...
    pinned_items: "Pinned",
    clear_history: "Clear unpinned history",
    quit_clipecho: "Quit ClipEcho",
    file: "File",
    folder: "Folder",
    files: "Files",
    folders: "Folders",
    ...
    window: "Window",
    help: "Help",
    about_clipecho: "About ClipEcho",
    services: "Services",
    hide_clipecho: "Hide ClipEcho",
...
const SIMPLIFIED_CHINESE_STRINGS: NativeStrings = NativeStrings {
    ...
    open_settings: "打开设置",
    pinned_items: "已固定",
    clear_history: "清空未固定的历史记录",
    quit_clipecho: "退出 ClipEcho",
    file: "文件",
    folder: "文件夹",
    files: "多个文件",
    folders: "多个文件夹",
    ...
    window: "窗口",
    help: "帮助",
    about_clipecho: "关于 ClipEcho",
    services: "服务",
    hide_clipecho: "隐藏 ClipEcho",
    hide_others: "隐藏其他",
    close_window: "关闭窗口",
    undo: "撤销",
    redo: "重做",
...
const TRADITIONAL_CHINESE_STRINGS: NativeStrings = NativeStrings {
    ...
    open_settings: "開啟設定",
    pinned_items: "已固定",
    clear_history: "清除未固定的歷史記錄",
    quit_clipecho: "結束 ClipEcho",
    file: "檔案",
    folder: "資料夾",
    files: "多個檔案",
    folders: "多個資料夾",
    ...
    window: "視窗",
    help: "輔助說明",
    about_clipecho: "關於 ClipEcho",
    services: "服務",
    hide_clipecho: "隱藏 ClipEcho",
    hide_others: "隱藏其他",
    close_window: "關閉視窗",
    undo: "還原",
    redo: "重做",
